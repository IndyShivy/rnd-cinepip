...
#If running for first time: Comment out lines 77-81, uncomment line 74 and add in file path
#If running as update to existing as a update to existing lb_tmdb.csv: Add in file path to 78 and 81 
